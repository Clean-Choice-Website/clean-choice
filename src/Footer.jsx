...
function Footer() {
  return (
    <>
      <footer className="mx-auto flex max-w-7xl flex-col items-center justify-between px-16 py-8 md:flex-row md:px-6 lg:px-16">
        <Link to="/">
        ...
        <div>
          <ul className="flex flex-col items-center gap-4 md:flex-row md:items-start md:gap-8">
            <Link to="/about">
