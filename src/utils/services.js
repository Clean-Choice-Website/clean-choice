export const commercialList = [
  "Tailored cleaning schedules designed to accommodate your business hours",
  "Disinfectant services prioritize the well-being of your employees and customers",
  "Customized cleaning solutions designed to meet your business's specific needs",
];
...
export const waxList = [
  ...
  "Ideal for high-traffic areas that need a refreshed, professional appearance",
];
...
export const rowReverse =
  "mb-4 md:mb-12 md:flex md:max-w-7xl md:flex-row-reverse md:items-center lg:gap-8";
